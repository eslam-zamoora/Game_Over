...
export default function () {
  ...
  const [revelenceGames, setrevelenceGames] = useState([])
  ...
  async function getrevelenceGames(){
    let {data} = await axios.request(options)
    setrevelenceGames(data)
  ...
  <div className="sk-chase-dot"></div>
    ...
    <div className="container">
      <div className="row row-cols-md-3 row-cols-sm-2 row-cols-lg-4 gy-5">
          ...
          {revelenceGames.map((game)=><div key={game.id} className='col'>
